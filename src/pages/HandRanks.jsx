	...
	return (
		...
		>
			...
			<div className="min-w-2/3 grid grid-cols-2 grid-rows-5 p-2 shadow-xl rounded-xl border border-gray-100">
				...
				<span className="p-4 text-lg text-center dark:text-slate-100">Straight Flush</span>
				...
				<span className="p-4 text-lg text-center dark:text-slate-100">Full House</span>
				...
				<span className="p-4 text-lg text-center dark:text-slate-100">Straight</span>
				<span className="p-4 text-lg text-center dark:text-slate-100">9♥ 8♣ 7♠ 6♦ 5♣</span>
				...
				<span className="p-4 text-lg text-center dark:text-slate-100">Two Pairs</span>
				...
				<span className="p-4 text-lg text-center dark:text-slate-100">High Card</span>
