const Games = () => {
	return (
		<section
			id="games"
			className="my-12 scroll-mt-20 min-h-screen relative flex flex-col"
		>
			<h2
				className="text-4xl font-bold text-center sm:text-5xl my-6 text-slate-900 dark:text-white"
			>
				Our Games
			</h2>
			<ul className="list-none mx-auto h-screen flex flex-col sm:flex-row gap-8">
				<li
					className="w-2/3 items-center sm:w-5/6 features-height flex flex-col border border-solid border-slate-900 dark:border-gray-100 bg-rose-50 dark:bg-black py-6 px-2 rounded-3xl shadow-xl">
				...
				<li
					className="w-2/3 sm:w-5/6 features-height flex flex-col items-center border border-solid border-slate-900 dark:border-gray-100 bg-rose-50 dark:bg-black py-6 px-2 rounded-3xl shadow-xl">
					<div className="flex text-center">
